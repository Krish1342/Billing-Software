...
class DatabaseConfig:
    ...
    @staticmethod
    def get_database_manager(prefer_online: bool = True) -> Union[SupabaseDatabaseManager, LocalDatabaseManager]:
        """
        ...
        if prefer_online:
            try:
                ...
                if supabase_url and supabase_key:
                    ...
                    print("⚠️  Supabase credentials not found - switching to offline mode")
    ...
    def is_online_mode() -> bool:
        ...
        try:
            supabase_url = os.getenv("SUPABASE_URL")
            supabase_key = os.getenv("SUPABASE_ANON_KEY")
            return bool(supabase_url and supabase_key and os.getenv('OFFLINE_MODE', '').lower() != 'true')
        except:
            return False
